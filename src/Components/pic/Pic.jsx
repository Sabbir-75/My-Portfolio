...
const iconComponents = {
    next: {
        component: () => <img src={next} alt={next} /> ,
        color: '#E34F26'
    },
    typescript: {
        component: () => <img src={typescript} alt={typescript} />  ,
        color: '#1572B6'
    },
    javascript: {
    ...
    mongodb: {
        component: () => <img src={mongodb} alt={mongodb} />  ,
        color: '#06B6D4'
    }
};
...
export default function OrbitingSkills({image}) {
